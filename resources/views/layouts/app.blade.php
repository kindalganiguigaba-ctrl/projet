  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="{{ url('/') }}" class="logo d-flex align-items-center me-auto">
        <img src="{{ asset("pictures/logo_armée.png") }}" class="img-fluid" style="width: 300px; max-height: 300px;"
          alt="Logo">
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul id="navy">
          ...
          <li><a class="active text-light fs-5" href="{{url('/login')}}">Se connecter</a></li>
          <li><a class="active text-light fs-5" href="{{url('/signin')}}">S'inscrire</a></a></li>
        </ul>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <img src="{{ asset("pictures/logo_armée.png") }}" class="img-fluid" style="width: 400px; max-height: 400px;"
            alt="Logo">
